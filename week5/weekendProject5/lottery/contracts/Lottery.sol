...
contract Lottery is Ownable {
    ...
    // Set an appropriate upper limit
    uint256 constant MAX_TIMES = 10;
    ...
    // Optimize betMany function
    function betMany(uint256 times) external {
        require(times <= MAX_TIMES, "Exceeds maximum allowed times");
    ...
    function prizeWithdraw(uint256 amount) external {
        require(amount <= prize[msg.sender], "Not enough fees collected");
